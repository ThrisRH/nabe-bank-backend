...
import com.myproject.nabe_bank.exception.ApiResponse;
...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<UserResponse>> getById(
        ...
        return ResponseEntity.ok(new ApiResponse<>(200, "SUCCESS", "User fetched successfully", response));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse<Void>> delete(@PathVariable Long id) {
        userService.delete(id);
        return ResponseEntity.ok(new ApiResponse<>(200, "SUCCESS", "User deleted successfully", null));
    }
    ...
    public ResponseEntity<ApiResponse<UserResponse>> update(@PathVariable Long id,
        ...
        return ResponseEntity.ok(new ApiResponse<>(200, "SUCCESS", "User updated successfully", response));
    }
